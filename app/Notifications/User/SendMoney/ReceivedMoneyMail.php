...
class ReceivedMoneyMail extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
                ...
                ->subject("Received Money From ".$data->requestData->sender_amount. ' ' .$data->requestData->sender_currency." to ".$data->requestData->receiver_amount.' '. $data->requestData->receiver_currency." Successfully")
                ->line("Your have received money successfully")
