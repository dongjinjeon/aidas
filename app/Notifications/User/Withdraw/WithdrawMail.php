...
class WithdrawMail extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->line("Request Amount: " . getAmount($data->amount,4).' '.$data->request_currency)
            ->line("Exchange Rate: " ." 1 ". $data->request_currency.' = '. getAmount($data->exchange_rate,4).' '.$data->gateway_currency)
            ...
            ->line("Total Payable Amount: " . get_amount($data->payable,$data->request_currency,'4'))
            ->line("Status: ". $status)
