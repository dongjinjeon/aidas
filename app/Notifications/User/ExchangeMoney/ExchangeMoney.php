...
class ExchangeMoney extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->line("Will Get: " .  getAmount($data['requestData']['exchange_to_amount'],4).$data['requestData']['exchange_to_currency'])
            ->line("Total Payable Amount: " . getAmount($data['chargeCalculate']->payable,4).$data['requestData']['exchange_from_currency'])
            ->line("Status: ". "Success")
