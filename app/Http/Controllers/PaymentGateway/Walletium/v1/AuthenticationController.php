...
class AuthenticationController extends Controller
{
    ...
    public function generateToken(Request $request) {
        $validator = Validator::make($request->all(),[
            ...
            // 'mode'          => "required|in:". PaymentGatewayConst::ENV_PRODUCTION . "," . PaymentGatewayConst::ENV_SANDBOX,
        ],[
        ...
        if(!$developer_credentials) return Response::paymentApiError(['Requested credentials is invalid']);
        ...
        if(!$merchant) return Response::paymentApiError(['Merchant doesn\'t exists or credentials is invalid'],[],404);
        ...
        try{
            ...
            DB::rollBack();
            return Response::paymentApiError(['Failed to create access token. Please try again'],[],500);
        }
