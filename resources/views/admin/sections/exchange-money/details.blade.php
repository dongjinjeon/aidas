...
@section('breadcrumb')
    @include('admin.components.breadcrumb', [
        ...
        'active' => __('Send Money Details'),
    ])
@endsection
@section('content')
<div class="custom-card">
    <div class="card-header">
        <h6 class="title">{{ __("Send Money Details") }}</h6>
    </div>
    <div class="card-body">
            ...
            <div class="row align-items-center mb-10-none">
                    ...
                    <ul class="user-profile-list-two">
                        ...
                        <li class="three">Receiver: <span>
                            @if($data->receiver_id != null)
                                    <a href="{{ setRoute('admin.users.details',$data->receiver->username) }}">{{ $data->receiver->fullname }} ({{ __("USER") }})</a>  
                            @endif
                            </span>
                        </li> 
                ...
                <div class="col-xl-4 col-lg-4 form-group">
                    <ul class="user-profile-list two">
                        ...
                        <li class="two">Conversion Amount: <span>{{ number_format(@$data->request_amount*$data->exchange_rate,2) }} {{ @$data->payment_currency }}</span></li>
                        <li class="three">Rate: <span>1 {{ $data->request_currency }} = {{ number_format(@$data->exchange_rate,2) }} {{ @$data->payment_currency }}</span></li>
                        <li class="four">Will Get: <span>{{ get_amount(@$data->receive_amount,$data->payment_currency) }}</span></li>
