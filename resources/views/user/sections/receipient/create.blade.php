...
<div class="add-recipient-item">
 <form action="{{ setRoute('user.receipient.store',['token' => request()->get('token')]) }}" method="post">
    @csrf
    <div class="trx-inputs">
        <div class="row"> 
            <div class="col-xl-12 col-lg-12 col-md-12 form-group">
                ...
                <input type="text" name="email" value="{{ old('email') }}" class="form--control email" placeholder="Enter Username Or Email...">
            </div> 
        </div>
            <div class="row">  
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 form-group">
                <div class="country-select-wrp">
                    <label>{{ __("Country") }}<span class="text--base">*</span></label> 
                    <select name="country" class="form--control select2-auto-tokenize country-select" data-placeholder="Select Country"></select>
                </div>
                </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-xl-6 form-group">
                    ...
                    <input type="number" name="zip" value="{{ old('zip') }}" class="form--control" placeholder="Enter Zip...">
                </div>
            </div>
            <div class="col-xl-12 col-lg-12 form-group">
                <label>{{ __("Address") }} <span class="text--base">*</span></label>
                <textarea class="form--control" name="address" placeholder="Write Here…">{{ old('address') }}</textarea>
            </div>
            <div class="back-btn">
            ...
            $.post(URL,data,function() {
                ...
                if(response.data == null) {
                    ...
                    if(user.address.country == undefined || user.address.country == "") {
                        ...
                        $(errorPlace).parents("form").find("select[name=country]").val(user.address.country ?? "");
