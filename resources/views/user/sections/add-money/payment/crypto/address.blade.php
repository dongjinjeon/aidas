                        ...
                        <div class="preview-list-item">
                            ...
                            <div class="preview-list-right">
                                <span class="text--warning fees">1 {{ get_default_currency_code() }} =
                                    {{ get_amount($transaction->user_wallet->currency->rate, $transaction->gateway_currency->currency_code,8) }}</span>
                            </div>
                        </div>
                        <div class="preview-list-item">
                            <div class="preview-list-left">
                            ...
                            <div class="preview-list-right">
                                <span class="text--warning fees">{{ get_amount($transaction->total_charge, $transaction->user_wallet->currency->code,4) }}</span>
                            </div>
                        </div>
                        <div class="preview-list-item">
                            <div class="preview-list-left">
